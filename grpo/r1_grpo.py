# Copied from https://github.com/huggingface/open-r1/blob/main/src/open_r1/grpo.py
#
...
SYSTEM_PROMPT = (
    ...
    "process and answer are enclosed within <think> </think> and <answer> </answer> tags with \\boxed{}, respectively, i.e., "
